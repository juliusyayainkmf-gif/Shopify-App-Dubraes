...
const shopifyApps = [
  createShopifyApp({
    apiKey: process.env.DUBRAES_SHOPIFY_API_KEY || process.env.SHOPIFY_API_KEY,
    apiSecretKey:
      process.env.DUBRAES_SHOPIFY_API_SECRET ||
      process.env.SHOPIFY_API_SECRET ||
      "",
    appUrl:
      process.env.DUBRAES_SHOPIFY_APP_URL || process.env.SHOPIFY_APP_URL || "",
    customShopDomains: splitEnv(
      process.env.DUBRAES_SHOP_CUSTOM_DOMAINS || process.env.SHOP_CUSTOM_DOMAIN,
    ),
  }),
  ...(process.env.KMF_SHOPIFY_API_KEY
    ? [
        createShopifyApp({
          apiKey: process.env.KMF_SHOPIFY_API_KEY,
          apiSecretKey: process.env.KMF_SHOPIFY_API_SECRET || "",
          appUrl:
            process.env.KMF_SHOPIFY_APP_URL ||
            process.env.SHOPIFY_APP_URL ||
            "",
          customShopDomains: splitEnv(process.env.KMF_SHOP_CUSTOM_DOMAINS),
        }),
      ]
    : []),
];
